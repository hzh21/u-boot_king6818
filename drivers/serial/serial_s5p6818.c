...
#define CONSOLE_PORT CONFIG_S5P6818_SERIAL_INDEX
#if (0 == CONSOLE_PORT)
...
static unsigned int   const clock_in = CONFIG_S5P6818_SERIAL_CLOCK;
...
{
	char dev[10];
	sprintf(dev, "nx-uart.%d", CONFIG_S5P6818_SERIAL_INDEX);
